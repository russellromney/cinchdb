...
def main():
    ...
    print("\nInserting users...")
    users = [
        {"username": "alice", "email": "alice@example.com", "full_name": "Alice Smith", "active": True},
        {"username": "bob", "email": "bob@example.com", "full_name": "Bob Jones", "active": True},
    ...
    updated = db.update("users", charlie["id"], {"active": True, "full_name": "Charlie Brown"})
    ...
    feature_db.create_table("profiles", [
    ...
    # Add sample profile
    profile = feature_db.insert("profiles", {
        "user_id": alice["id"],
