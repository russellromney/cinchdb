...
class SaaSApplication:
    ...
    def onboard_customer(self, company_name: str, admin_email: str, plan: str = "trial"):
    ...
    def simulate_activity(self, tenant_name: str):
        ...
        project = tenant_db.insert("projects", {
            "account_id": tenant_db.query("SELECT id FROM accounts LIMIT 1")[0]["id"],
