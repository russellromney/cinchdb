...
class ProjectInitializer:
    ...
    def init_project(self, 
                    ...
                    branch_name: str = "main") -> ProjectConfig:
    ...
    def _create_database_structure(self,
        ...
        branch_path = self.config_dir / "databases" / database_name / "branches" / branch_name
...
def init_project(project_dir: Optional[Path] = None,
                database_name: str = "main",
                branch_name: str = "main") -> ProjectConfig:
...
def init_database(project_dir: Optional[Path] = None,
                 database_name: str = "main",
                 branch_name: str = "main",
                 description: Optional[str] = None) -> None:
    """Initialize a new database within an existing project.
