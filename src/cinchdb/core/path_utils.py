...
def get_tenant_path(project_root: Path, database: str, branch: str, tenant: str) -> Path:
...
def get_tenant_db_path(project_root: Path, database: str, branch: str, tenant: str) -> Path:
