...
class BranchManager:
    ...
    def get_branch_metadata(self, branch_name: str) -> Dict[str, Any]:
        ...
        Returns:
            Metadata dictionary
        """
        metadata_path = get_branch_path(self.project_root, self.database, branch_name) / "metadata.json"
    ...
    def update_branch_metadata(self, branch_name: str, metadata: Dict[str, Any]) -> None:
