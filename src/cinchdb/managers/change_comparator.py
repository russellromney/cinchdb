...
class ChangeComparator:
    ...
    def find_common_ancestor(self, source_branch: str, target_branch: str) -> Optional[str]:
    ...
    def get_divergent_changes(self, source_branch: str, target_branch: str) -> Tuple[List[Change], List[Change]]:
    ...
    def can_fast_forward_merge(self, source_branch: str, target_branch: str) -> bool:
        ...
        """
        source_only, target_only = self.get_divergent_changes(source_branch, target_branch)
    ...
    def detect_conflicts(self, source_branch: str, target_branch: str) -> List[str]:
        ...
        if overlapping:
            conflicts.extend([f"Both branches modified {entity}" for entity in overlapping])
