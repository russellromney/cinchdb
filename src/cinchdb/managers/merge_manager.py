...
class MergeManager:
    ...
    def _merge_branches_internal(self, source_branch: str, target_branch: str, force: bool = False) -> Dict[str, Any]:
    ...
    def merge_branches(self, source_branch: str, target_branch: str, force: bool = False) -> Dict[str, Any]:
        ...
        return self._merge_branches_internal(source_branch, target_branch, force)
    ...
    def merge_into_main(self, source_branch: str) -> Dict[str, Any]:
        ...
        return self._merge_branches_internal(source_branch, "main")
