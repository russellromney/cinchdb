...
class TenantManager:
    ...
    def create_tenant(self, tenant_name: str, description: Optional[str] = None) -> Tenant:
        ...
        # Get paths
        main_db_path = get_tenant_db_path(self.project_root, self.database, self.branch, "main")
        new_db_path = get_tenant_db_path(self.project_root, self.database, self.branch, tenant_name)
    ...
    def delete_tenant(self, tenant_name: str) -> None:
        ...
        if tenant_name not in list_tenants(self.project_root, self.database, self.branch):
    ...
    def copy_tenant(self, source_tenant: str, target_tenant: str) -> Tenant:
        ...
        # Get paths
        source_path = get_tenant_db_path(self.project_root, self.database, self.branch, source_tenant)
        target_path = get_tenant_db_path(self.project_root, self.database, self.branch, target_tenant)
    ...
    def rename_tenant(self, old_name: str, new_name: str) -> None:
        ...
        # Get paths
        old_path = get_tenant_db_path(self.project_root, self.database, self.branch, old_name)
        new_path = get_tenant_db_path(self.project_root, self.database, self.branch, new_name)
