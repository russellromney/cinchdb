...
class Change(CinchDBTableModel):
    ...
    details: Dict[str, Any] = Field(default_factory=dict, description="Change-specific details")
    sql: Optional[str] = Field(default=None, description="SQL statement that implements the change")
