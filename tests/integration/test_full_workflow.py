...
class TestFullWorkflow:
    ...
    def test_complete_database_workflow(self, temp_project):
        ...
        # Create users table
        users_table = table_mgr.create_table("users", [
        ...
        # Create posts table
        posts_table = table_mgr.create_table("posts", [
        ...
        view_mgr.create_view("user_posts", """
    ...
    def test_multi_branch_development(self, temp_project):
        ...
        users_table_mgr.create_table("users", [
        ...
        products_table_mgr = TableManager(temp_project, "main", "feature_products", "main")
        products_table_mgr.create_table("products", [
            Column(name="name", type="TEXT", nullable=False),
