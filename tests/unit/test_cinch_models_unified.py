...
class TestCinchModelsUnified:
    ...
    def test_cinch_models_invalid_connection(self, generated_models_dir):
        ...
        try:
            ...
            with pytest.raises(
                TypeError, match="CinchModels requires a CinchDB connection instance"
            ):
    ...
    def test_model_access_and_initialization(
        self, project_with_tables, generated_models_dir
    ):
    ...
    def test_model_no_set_connection_method(self, generated_models_dir):
        ...
        assert (
            "Model not initialized. Access models through CinchModels container."
            in users_content
        )
