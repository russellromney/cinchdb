...
class TestUnifiedCodegenCLI:
    ...
    def test_local_generation(self, mock_codegen_manager, mock_config_data, temp_project):
    ...
    @patch('cinchdb.cli.handlers.codegen_handler.CodegenManager')
    def test_get_supported_languages_local_fallback(self, mock_codegen_manager, mock_config_data_with_api):
