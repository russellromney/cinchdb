...
class TestCinchDatabase:
    ...
    def test_local_managers_lazy_load(self, tmp_path):
        ...
        with patch("cinchdb.managers.table.TableManager") as mock_table_manager:
            _ = db.tables
            mock_table_manager.assert_called_once_with(tmp_path, "test_db", "main", "main")
    ...
    def test_local_query(self, tmp_path):
        ...
        with patch("cinchdb.managers.query.QueryManager") as mock_query_manager:
            ...
            mock_query_manager.assert_called_once_with(tmp_path, "test_db", "main", "main")
            mock_instance.execute.assert_called_once_with("SELECT * FROM users WHERE id = ?", [1])
