...
class TestMaintenanceMode:
    ...
    def setup_method(self):
        ...
        self.column_manager = ColumnManager(self.project_root, self.database, self.branch)
        ...
        self.tenant_manager = TenantManager(self.project_root, self.database, self.branch)
        self.change_applier = ChangeApplier(self.project_root, self.database, self.branch)
