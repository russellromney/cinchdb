...
class TestModels:
    ...
    def test_project_creation(self):
        ...
        project = Project(name="test_project", path="/tmp/test")
    ...
    def test_branch_creation(self):
        ...
        branch = Branch(name="feature", database="test_db", parent_branch="main")
    ...
    def test_tenant_creation(self):
        ...
        tenant = Tenant(name="customer1", branch="main", database="test_db")
