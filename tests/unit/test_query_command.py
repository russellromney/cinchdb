...
class TestQueryCommand:
    ...
    def temp_project(self):
        ...
        with DatabaseConnection(db_path) as conn:
            conn.execute("INSERT INTO users (id, created_at, name, email) VALUES ('1', '2023-01-01', 'Alice', 'alice@example.com')")
            conn.execute("INSERT INTO users (id, created_at, name, email) VALUES ('2', '2023-01-02', 'Bob', 'bob@example.com')")
            conn.commit()
    ...
    def test_query_select_basic(self, temp_project):
        ...
        result = self.run_query_command(["query", "SELECT name FROM users"], temp_project)
    ...
    def test_query_select_with_tenant(self, temp_project):
        ...
        result = self.run_query_command(["query", "SELECT name FROM users", "--tenant", "main"], temp_project)
    ...
    def test_query_json_format(self, temp_project):
        ...
        result = self.run_query_command(["query", "SELECT name FROM users", "--format", "json"], temp_project)
    ...
    def test_query_csv_format(self, temp_project):
        ...
        result = self.run_query_command(["query", "SELECT name FROM users", "--format", "csv"], temp_project)
    ...
    def test_query_with_limit(self, temp_project):
        ...
        result = self.run_query_command(["query", "SELECT name FROM users", "--limit", "1"], temp_project)
    ...
    def test_query_insert(self, temp_project):
        ...
        result = self.run_query_command([
            "query", "INSERT INTO users (id, created_at, name, email) VALUES ('3', '2023-01-03', 'Charlie', 'charlie@example.com')"
        ], temp_project)
    ...
    def test_query_no_results(self, temp_project):
        ...
        result = self.run_query_command(["query", "SELECT * FROM users WHERE name = 'NonExistent'"], temp_project)
